...
class FilterViewController: UIViewController,UITextFieldDelegate,UIPickerViewDataSource {
...
//        district = "Rajkot"
    ...
    @IBAction func applyClicked (){
        ...
        if delegate != nil {
            delegate?.userDidEnterData(country: country!, state: state!, district: district!, accommodation: accommodation!, food: food!)
            dismiss(animated: true, completion: nil)
        }
    }
