...
let kBasePath               = "http://krishnapranami.org/ws/api/v1/"
let kLogin                  = "login/index.php#login"
let kRegister               = "login/index.php#register"
let kForgotPass             = "login/index.php#forgot"
let kEgurukolamVideoList    = "egurukulam/index.php#listVideos"
let kEgurukolamVideoSection = "egurukulam/index.php#listSections"
let kSetNotificationToken   = "general/index.php"
let kGetPatrikaList         = "patrika/index.php"
let kGetNotification        = "notification_list/index.php"
let kGetDonorList           = "donor/index.php"
...
//ALERT MESSAGES
let kEntetEmailMobile:           String = "Please Enter Your Email or Mobile"
let kEntetPassword:              String = "Please Enter Your Password"
let kEntetFullName:              String = "Please Enter Your Full Name"
let kEntetEmail:                 String = "Please Enter Your Email"
let kEntetValidEmail:            String = "Please Enter Your Valid Email"
let kEntetMobile:                String = "Please Enter Your Mobile"
let kEntetCity:                  String = "Please Enter Your City"
let kEnterState:                 String = "Please Enter Your State"
...
let kCooectConfirmPass:          String = "Please Enter Correct Confirm Password"
...
class Constant: NSObject,CLLocationManagerDelegate {
    ...
    static let PRIMARY_COLOR = UIColor.init(red: 21.0/255.0, green: 129.0/255.0, blue: 198.0/255.0, alpha: 1.0)
...
extension String {
    ...
    var attributedStringFromHtml: NSAttributedString? {
        do {
            return try NSAttributedString(data: self.data(using: String.Encoding.utf8)!, options: [NSAttributedString.DocumentReadingOptionKey.documentType : NSAttributedString.DocumentType.html], documentAttributes: nil)
        } catch _ {
...
extension UILabel {
    func underlinetext(text: String,color : UIColor) {
        ...
        attributedText.addAttribute(NSAttributedString.Key.underlineColor, value: color, range: textRange)
